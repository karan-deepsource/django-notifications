...
class NotificationTest(TestCase):
    ...
    def test_use_timezone(self):
        from_user = User.objects.create(username="from",
                                        password="pwd",
                                        email="example@example.com")
        to_user = User.objects.create(username="to",
                                      password="pwd",
                                      email="example@example.com")
        notify.send(from_user,
                    recipient=to_user,
                    verb="commented",
    ...
    def test_disable_timezone(self):
        from_user = User.objects.create(username="from2",
                                        password="pwd",
                                        email="example@example.com")
        to_user = User.objects.create(username="to2",
                                      password="pwd",
                                      email="example@example.com")
        notify.send(from_user,
                    recipient=to_user,
...
class NotificationManagersTest(TestCase):
    ...
    def setUp(self):
        ...
        self.other_user = User.objects.create(username="other1",
                                              password="pwd",
                                              email="example@example.com")

        self.from_user = User.objects.create(username="from2",
                                             password="pwd",
                                             email="example@example.com")
        self.to_user = User.objects.create(username="to2",
                                           password="pwd",
                                           email="example@example.com")
    ...
    def test_mark_all_deleted_manager(self):
        ...
        self.assertEqual(Notification.objects.deleted().count(),
                         self.message_count)
...
class NotificationTestPages(TestCase):
    ...
    def setUp(self):
        self.message_count = 10
        self.from_user = User.objects.create_user(username="from",
                                                  password="pwd",
                                                  email="example@example.com")
        self.to_user = User.objects.create_user(username="to",
                                                password="pwd",
                                                email="example@example.com")
...
class NotificationTestExtraData(TestCase):
    ...
    def test_extra_data(self):
        ...
        self.assertEqual(data["unread_list"][0]["data"]["other_content"],
                         "Hello my 'world'")
...
class AdminTest(TestCase):
    ...
    def test_list(self):
        ...
        with CaptureQueriesContext(connection=connection) as context:
            response = self.client.get(
                reverse("admin:{0}_notification_changelist".format(
                    self.app_name)))
